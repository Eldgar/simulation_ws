...
"""autogenerated by genpy from tortoisebot_waypoints/WaypointActionActionResult.msg. Do not edit."""
import codecs
import sys
...
class WaypointActionActionResult(genpy.Message):
  _md5sum = "0698ce25b2d595b82357c010557e935f"
  _type = "tortoisebot_waypoints/WaypointActionActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','tortoisebot_waypoints/WaypointActionResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(WaypointActionActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = tortoisebot_waypoints.msg.WaypointActionResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = tortoisebot_waypoints.msg.WaypointActionResult()
