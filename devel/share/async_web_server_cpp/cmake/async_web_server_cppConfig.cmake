...
if("TRUE" STREQUAL "TRUE")
  set(async_web_server_cpp_SOURCE_PREFIX /home/user/simulation_ws/src/async_web_server_cpp)
  set(async_web_server_cpp_DEVEL_PREFIX /home/user/simulation_ws/devel)
  ...
  set(async_web_server_cpp_INSTALL_PREFIX /home/user/simulation_ws/install)
...
if(NOT "/home/user/simulation_ws/src/async_web_server_cpp/include;/usr/include " STREQUAL " ")
  set(async_web_server_cpp_INCLUDE_DIRS "")
  set(_include_dirs "/home/user/simulation_ws/src/async_web_server_cpp/include;/usr/include")
  if(NOT "https://github.com/fkie/async_web_server_cpp/issues " STREQUAL " ")
    set(_report "Check the issue tracker 'https://github.com/fkie/async_web_server_cpp/issues' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT "http://ros.org/wiki/async_web_server_cpp " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'Timo Röhling <timo.roehling@fkie.fraunhofer.de>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'async_web_server_cpp' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/user/simulation_ws/src/async_web_server_cpp/${idir}'.  ${_report}")
    endif()
    _list_append_unique(async_web_server_cpp_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "async_web_server_cpp;/usr/lib/x86_64-linux-gnu/libboost_filesystem.so.1.71.0;/usr/lib/x86_64-linux-gnu/libboost_regex.so.1.71.0;/usr/lib/x86_64-linux-gnu/libboost_thread.so.1.71.0")
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(async_web_server_cpp_EXPORTED_TARGETS ${${async_web_server_cpp_dep}_EXPORTED_TARGETS})
endforeach()
